  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
        ...
        <div className="reveal grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {pillars.map((pillar, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 flex items-center justify-center border border-white/30 rounded-full">
        ...
        <a
          href="#architecture"
          className="reveal inline-block btn-primary"
        >
          {t('vision.cta')}
        </a>
      </div>
